...
def plot_classic_orbital_elements_overlay(*orbital_elementss_lists):
    ...
    for orbital_elementss_list in orbital_elementss_lists:
        ...
        axs[0, 0].set_xlabel('Time (s)')
        axs[0, 0].set_ylabel('Major Axis (km)')
        axs[0, 0].ticklabel_format(style='plain', useOffset=False, axis='y')
        axs[0, 0].grid(True)
        axs[0, 0].legend()
        ...
        axs[0, 1].set_xlabel('Time (s)')
        axs[0, 1].set_ylabel('Eccentricity')
        axs[0, 1].ticklabel_format(style='plain', useOffset=False, axis='y')
        axs[0, 1].grid(True)
        axs[0, 1].legend()
        ...
        axs[1, 0].ticklabel_format(style='plain', useOffset=False, axis='y')
        axs[1, 0].grid(True)
        axs[1, 0].legend()
        ...
        axs[1, 1].set_xlabel('Time (s)')
        axs[1, 1].set_ylabel('Ascending Node (degrees)')
        axs[1, 1].ticklabel_format(style='plain', useOffset=False, axis='y')
        axs[1, 1].grid(True)
        axs[1, 1].legend()
        ...
        axs[2, 0].set_xlabel('Time (s)')
        axs[2, 0].set_ylabel('Argument of Perigee (degrees)')
        axs[2, 0].ticklabel_format(style='plain', useOffset=False, axis='y')
        axs[2, 0].grid(True)
        axs[2, 0].legend()
        ...
        axs[2, 1].set_xlabel('Time (s)')
        axs[2, 1].set_ylabel('True Anomaly (degrees)')
        axs[2, 1].ticklabel_format(style='plain', useOffset=False, axis='y')
        axs[2, 1].grid(True)
        axs[2, 1].legend()
    plt.tight_layout()
    plt.show()
